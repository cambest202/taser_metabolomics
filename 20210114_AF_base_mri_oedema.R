...
mri_pre_limma <- mri_resp[, c(4,1470,12:1469)]
...
set.seed(42)
index <- createDataPartition(mri_resping$Oedema_Response, p = 0.85, list = FALSE)
...
write.csv(imps_hmdb_id, '20210115_AF_base_mri_oedema_FI.csv')
...
write.csv(stat_test, '20210115_AF_base_mri_oedema_stats.csv')
